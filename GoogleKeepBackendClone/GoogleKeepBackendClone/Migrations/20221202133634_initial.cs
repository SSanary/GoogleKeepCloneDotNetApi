    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GeneralNoteInfo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GeneralNoteInfo_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GeneralNoteInfo_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAchived = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    LastChangeTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    Context = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GeneralNoteInfo_TagId",
                table: "GeneralNoteInfo",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_GeneralNoteInfo_UserId",
                table: "GeneralNoteInfo",
                column: "UserId");
